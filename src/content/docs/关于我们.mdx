...
<Tabs>
  <TabItem label="裤衩美照1">**查看裤衩美照**</TabItem>
  <TabItem label="裤衩美照2">**查看裤衩美照**</TabItem>
  <TabItem label="裤衩美照3">**查看裤衩美照**</TabItem>
  <TabItem label="裤衩美照4">**查看裤衩美照**</TabItem>
</Tabs>
...
:::warning
计算机保研交流群（绿群，含本网站和对应 Github 组织及下属仓库）本着开源精神进行非盈利分享，加群与资料分享等**无任何付费项目，请谨防被骗！**仓库中如有部分第三方内容涉及引流付费均非绿群团队所为，请及时通过 [issue](https://github.com/CS-BAOYAN/CS-BAOYAN-Wiki/issues) 等方式联系我们撤下。
:::
